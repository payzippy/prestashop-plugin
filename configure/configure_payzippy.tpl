...
<html>
<head>
<link rel="stylesheet" type="text/css" href="{$module_template_dir}configure/plugin-css.css">
</head>
<body>
<div class="all-content">
  <header class="header-wr">
    <div class="payzippy-logo-wr">
      <img src="{$module_template_dir}configure/payzippy-logo.png" alt="PAYZIPPY"/>
    </div>
  </header>
  <div class="main-wr">
    <div class="head-wr">
    ...
    <div class="pay-mthds-wr">
      <div class="cr-db-wr clear-both">
        ...
        <div class="cr-db-logos">
          <img src="{$module_template_dir}configure/visa-icons.png" alt="VISA ICONS"/>
        </div>
      </div>
      <div class="net-bk-wr clear-both">
        <div class="net-bk-txt">Net Banking</div>
        <div class="net-bk-logos">
          <img src="{$module_template_dir}configure/supported-banks.png" alt=""/>
        </div>
    ...
    <div class="cred-frm-wr">
      <form action="{$URI}" method="post" class="cred-frm">
        ...
        <div class="pay_1-wr pull-left"><input type="radio" class="radio-btn-pay" name="payment_button" value="Paybutton-1" {$checked1} checked/><img src="{$module_template_dir}configure/Paybutton-1.png" alt="PAYZIPPY" class="radio-btn-image" /></div>
        <div class="pay_2-wr pull-left"> <input type="radio" name="payment_button" value="Paybutton-2" {$checked2}/><img src="{$module_template_dir}configure/Paybutton-2.png" alt="PAYZIPPY" class="radio-btn-image" /></div>
        <div class="pay_3-wr pull-left"> <input type="radio" name="payment_button" value="Paybutton-3" {$checked3}/><img src="{$module_template_dir}configure/Paybutton-3.png" alt="PAYZIPPY" class="radio-btn-image" /></div>
        <div class="pay_4-wr pull-left"> <input type="radio" name="payment_button" value="Paybutton-4" {$checked4}/><img src="{$module_template_dir}configure/Paybutton-4.png" alt="PAYZIPPY" class="radio-btn-image" /></div>
        <div class="pay_5-wr pull-left"> <input type="radio" name="payment_button" value="Paybutton-5" {$checked5}/><img src="{$module_template_dir}configure/Paybutton-5.png" alt="PAYZIPPY" class="radio-btn-image" /></div></br></br></br></br></br>
