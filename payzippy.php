	...
	public function getContent()
	{
		if (isset($_REQUEST['update_settings']))
		{
			...
			if(!sizeof($this->errors))
        		...
        		Configuration::updateValue('MERCHANT_ID', strval($_REQUEST['merchant_id']));
				Configuration::updateValue('SECRET_KEY', strval($_REQUEST['secretkey']));
				Configuration::updateValue('MERCHANT_KEY_ID', strval($_REQUEST['merchant_key_id']));
				Configuration::updateValue('PAYMENT_BUTTON', strval($_REQUEST['payment_button']));
				Configuration::updateValue('UI_MODE', strval($_REQUEST['ui_mode']));
